        ...
        <div className="w-full max-w-md">
          <div className="bg-white login-card p-10 rounded-3xl text-center">
            <div className="mb-8 flex flex-col items-center">
              ...
              <p className="text-slate-500 px-2">Enter the email associated with your account and we'll send you a link to reset your password.</p>
            </div>
            ...
            <div className="mt-8">
              ...
              >
                <Icon icon="lucide:arrow-left" /> Return to Login
              </Link>
            </div>
          </div>
        </div>
