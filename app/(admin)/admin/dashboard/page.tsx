...
const topCampaigns = [
  { initials: "AQ", avatarBg: "bg-red-100", avatarColor: "text-red-600", name: "AquaPure Summer Rush", sponsor: "Masafi Water", bottles: "5,000", scans: "14,203", clicks: "1,402", leads: "—" },
  { initials: "EG", avatarBg: "bg-amber-100", avatarColor: "text-amber-600", name: "Etisalat 5G Launch", sponsor: "Etisalat UAE", bottles: "3,500", scans: "9,102", clicks: "840", leads: "112" },
  { initials: "DL", avatarBg: "bg-emerald-100", avatarColor: "text-emerald-600", name: "Dubai Logistics Exp", sponsor: "DP World", bottles: "8,200", scans: "7,845", clicks: "630", leads: "—" },
  { initials: "EM", avatarBg: "bg-purple-100", avatarColor: "text-purple-600", name: "Emirates Skywards", sponsor: "Emirates", bottles: "12,000", scans: "6,102", clicks: "480", leads: "54" },
  { initials: "ST", avatarBg: "bg-gray-100", avatarColor: "text-gray-600", name: "Starter Pilot V1", sponsor: "FreeDrops Lab", bottles: "2,000", scans: "4,102", clicks: "210", leads: "18" },
];
            ...
            {campaignStatus.map((s) => (
              <div key={s.label} className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-gray-900">{s.label} ({s.count})</span>
                ...
                {topCampaigns.map((c) => (
                  <AnimatedRow key={c.name} className="text-sm text-gray-700">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className={`w-8 h-8 rounded ${c.avatarBg} flex items-center justify-center ${c.avatarColor} font-bold text-xs`}>
                          {c.initials}
                        </div>
                        <span className="font-medium">{c.name}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">{c.sponsor}</td>
